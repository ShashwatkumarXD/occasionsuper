...
const ReviewCard = ({ review }) => {
    return (
        <div className="bg-white p-6 rounded-2xl shadow-md hover:shadow-lg transition-shadow flex flex-col justify-between h-full outline-1 outline-[#E69B83]">
            ...
            <p className="italic text-gray-600 mb-6 flex-grow">{review.text}</p>
