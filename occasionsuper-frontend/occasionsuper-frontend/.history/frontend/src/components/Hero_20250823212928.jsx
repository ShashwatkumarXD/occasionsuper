...
function Hero() {
  return (
    <div className="h-[90vh] w-full relative overflow-hidden">
      ...
      {/* Content section */}
      <section className="relative z-10 h-full w-full px-8 md:px-16 flex flex-col items-center justify-start pt-16">
        {/* Left content */}
        <div className="w-full md:w-3/4 space-y-8 text-center">
          <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 leading-snug">
            "Plan Your Dream Event – Start Here"
          </h1>

          {/* Search bar */}
          <div className="flex bg-black text-white px-6 py-4 rounded-lg w-full md:w-[80%] mx-auto items-center shadow-lg">
      ...
      <div className="absolute bottom-0 right-0 w-1/2 h-full flex items-end justify-end">
        <img
          src={Image}
          alt="Bride"
          className="h-[140%] object-cover absolute bottom-0 right-0 -translate-y-12 drop-shadow-2xl"
        />
      </div>
    </div>
  )
