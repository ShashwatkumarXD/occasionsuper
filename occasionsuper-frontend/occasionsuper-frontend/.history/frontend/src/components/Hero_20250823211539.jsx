...
function Hero() {
  return (
    <div className="h-[90vh] w-full relative overflow-hidden">
      ...
      {/* Content section */}
      <section className="relative z-10 h-full w-full px-80 md:px-16 flex flex-col md:flex-row items-center justify-between">
        ...
        <div className="w-screen h-full flex items-end justify-end relative">
          <img
            src={Image}
            alt="Bride"
            className="h-[120%] object-cover absolute border-10 bottom-0 right-0 translate-x-20 -translate-y-40 drop-shadow-2xl"
          />
        </div>
      </section>
    </div>
