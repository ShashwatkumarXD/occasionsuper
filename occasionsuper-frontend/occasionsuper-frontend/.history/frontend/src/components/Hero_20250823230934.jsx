  ...
  return (
    <div className="h-[90vh] w-full relative overflow-hidden">
      ...
      <section className="relative z-10  h-full w-full px-8 md:px-16 flex  md:flex-row items-center justify-end  pt-16">
        ...
        <div className="w-3/5  mt-auto h-[70%] flex items-end justify-end relative">
          <img
            src={Image}
            alt="Bride"
            className="h-[140%] object-cover absolute bottom-0 right-0 translate-x-16 -translate-y-16 drop-shadow-2xl"
          />
        </div>
      </section>
    </div>
