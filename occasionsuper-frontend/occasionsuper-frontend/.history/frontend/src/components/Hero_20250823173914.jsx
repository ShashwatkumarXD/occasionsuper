...
function Hero() {
  return (
    <section 
      className="h-[80vh] w-full border-8 border-red-500 bg-yellow-400 relative px-6 py-16 flex flex-col md:flex-row items-center bg-cover bg-center bg-no-repeat"
      style={{
