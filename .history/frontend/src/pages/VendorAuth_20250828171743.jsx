        ...
        <div className="relative z-10 w-[90%] max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="text-white md:pr-8">
            ...
            <button
              ...
              className="bg-[#E69B83] hover:shadow-md hover:shadow-[#E69B83] hover:scale-105 hover:bg-[#c16a4d] font-semibold p-4 rounded-lg transition-all hover:cursor-pointer"
            >
              Join as a Partner
            </button>
          </div>
