                    ...
                    <div className="bg-white shadow rounded-2xl p-5 space-y-6">
                        <div>
                            ...
                            <select className="w-full rounded-lg p-2 outline-2 outline-[#E69B83]">
                                <option className="bg-white text-gray-700 font-medium">Most Popular</option>
                                <option className="bg-white text-gray-700 hover:bg-orange-100">Price: Low to High</option>
                                <option className="bg-white text-gray-700 hover:bg-orange-100">>Price: High to Low</option>
                            </select>
                        </div>
