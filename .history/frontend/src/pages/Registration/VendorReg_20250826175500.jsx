        ...
        <div className="relative z-10 w-[90%] max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          <div className="text-white md:pr-8">
            ...
            <button
              ...
              className="bg-global-gradient hover:bg-white hover:text-global-gradient text-white font-semibold py-3 px-8 rounded-lg transition-all hover:cursor-pointer"
            >
              Join as a Partner
            </button>
          </div>
