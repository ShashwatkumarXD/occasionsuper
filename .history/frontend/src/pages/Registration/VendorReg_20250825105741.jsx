  ...
  const features = [
    {
      ...
      title: "1. Guaranteed Business Opportunities",
      description: (
    ...
    {
      title: "2. Hassle-Free Vendor Experience",
      description: (
        <ul className="list-disc pl-5 space-y-1">
    ...
    {
      title: "3. On-Time & Secure Payments",
      description: (
        <ul className="list-disc pl-5 space-y-1">
    ...
    {
      title: "4. Increased Online Visibility",
      description: (
        <ul className="list-disc pl-5 space-y-1">
    ...
    {
      title: "5. End-to-End Event Management",
      description: (
        <ul className="list-disc pl-5 space-y-1">
