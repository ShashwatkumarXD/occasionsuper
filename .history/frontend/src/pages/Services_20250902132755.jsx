            ...
            <div className="grid grid-cols-4 gap-8">
                ...
                <div className="col-span-1 flex flex-col gap-6">
                    ...
                    <div className="bg-white shadow rounded-2xl p-5 space-y-6">
                        ...
                        <div>
                            <h2 className="font-semibold text-lg mb-3"><Shield>OccasionSuper Guarantee</Shield></h2>
                            <ul className="text-sm text-gray-600 space-y-2">
                                <li><CheckCircle>Quality assured services</CheckCircle></li>
                                <li><CheckCircle>Transparent pricing</CheckCircle></li>
                                <li><CheckCircle>24/7 support</CheckCircle></li>
                                <li><CheckCircle>Money-back guarantee</CheckCircle></li>
                            </ul>
                        </div>
                    </div>
                </div>
