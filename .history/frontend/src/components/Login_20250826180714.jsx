  ...
  return (
    <div className="bg-white shadow-xl rounded-2xl p-8 md:p-12">
      ...
      <form className="space-y-5">
        ...
        <button
          type="submit"
          className="w-full text-2xl bg-global-gradient text-white font-bold p-2 rounded-lg transition-all hover:shadow-md hover:shadow-orange-500 hover:cursor-pointer"
        >
          Login
        </button>
      </form>
