            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex items-center h-16 justify-between px-8">
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <button
                            onClick={() => navigate("/vendorReg")}
                            className="bg-global-gradient text-white font-medium text-xl p-2 rounded-xl shadow-md border-2 border-transparent hover:bg-white hover:text-global-gradient hover:border-orange-600 transform hover:scale-110 transition-all duration-1000 ease-in-out cursor-pointer"
                        >
                            Register as Vendor
                        </button>
                    </div>
