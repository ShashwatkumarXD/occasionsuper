    ...
    <div className="h-[90vh] w-full relative overflow-hidden mt-16">
      ...
      <section className="relative mt-10 z-10 h-full w-full flex md:flex-row items-center justify-end">
        ...
        <div className="w-[60%] h-fit -translate-y-20 translate-x-20 items-center">
          ...
          {/* <h1 className="text-5xl md:text-5xl font-extrabold text-global-gradient">
            "Plan Your Dream Event
          </h1>
          <h1 className="text-center text-5xl md:text-5xl font-extrabold text-global-gradient">
            – Start Here"
          </h1> */}
          <h1 className="text-5xl md:text-5xl font-extrabold text-global-gradient [text-shadow:0_0_12px_rgba(249,115,22,0.8)]">
  "Plan Your Dream Event
</h1>

<h1 className="text-center text-5xl md:text-5xl font-extrabold text-global-gradient [text-shadow:0_0_12px_rgba(249,115,22,0.8)]">
  – Start Here"
</h1>
