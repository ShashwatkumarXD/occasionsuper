  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex items-center gap-2 bg-global-gradient text-white font-medium text-xl p-2 rounded-xl shadow-md border-2 border-transparent hover:bg-white hover:text-orange-500 hover:border-orange-600 transform hover:scale-105 transition-all duration-500 ease-in-out cursor-pointer"
      >
        <Search size={18}/>
        Search
      </button>
