            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex items-center h-16 justify-between px-8">
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <button
                            onClick={() => navigate("/vendorReg")}
                            className="bg-white text-white font-medium text-xl p-2 rounded-xl shadow-md border-2 border-global-gradient hover:bg-white hover:text-global-gradient  transition duration-300 ease-in-out hover:cursor-pointer"
                        >
                            Register as Vendor
                        </button>
                    </div>
