  ...
  return (
    <div className="h-[90vh] w-full relative overflow-hidden mt-16">
      ...
      <section className="relative mt-10 z-10 h-full w-full flex md:flex-row items-center justify-end">
        {/* Left content */}
        <div className="w-[60%] h-fit -translate-y-20 translate-x-20 items-center">
          {/* <h1 className="text-5xl px-1 font-bold text-global-gradient leading-snug">
            "Plan Your Dream Event
          </h1>
          <h1 className="text-5xl text-center px-1 font-bold text-global-gradient leading-snug">
            – Start Here"
          </h1> */}
          <h1 className="text-5xl md:text-5xl font-extrabold bg-gradient-to-r from-orange-500 via-pink-500 to-purple-600 bg-clip-text text-transparent tracking-tight leading-tight drop-shadow-sm">
            "Plan Your Dream Event
          </h1>
          <h1 className="text-center text-5xl md:text-5xl font-extrabold bg-gradient-to-r from-orange-500 via-pink-500 to-purple-600 bg-clip-text text-transparent tracking-tight leading-tight drop-shadow-sm">
            – Start Here"
          </h1>
        </div>
        ...
        <div className="w-[60%] mt-auto h-[70%] flex items-end justify-end relative">
          <img
            src={Image}
            alt="Bride"
            className="h-[130%] object-cover absolute bottom-0 right-0 translate-x-20 -translate-y-16 "
          />
        </div>
      </section>
    </div>
