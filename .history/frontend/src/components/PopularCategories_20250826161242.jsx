  ...
  return (
    <section className="p-8 bg-white">
      <div className="mx-auto">
        {/* Section Title */}
        <div className="p-2 h-fit border-2 mb-4">
          <h2 className="text-3xl font-bold text-global-gradient">
            Popular Categories
          </h2>
        </div>

        {/* Categories Grid */}
        <div className="border-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
