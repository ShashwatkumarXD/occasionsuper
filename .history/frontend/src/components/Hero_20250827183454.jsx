        ...
        <section className="relative w-full bg-white p-8">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-8">
                    {/* Badge */}
                    <div className="text-lg inline-flex items-center gap-2 bg-gradient-to-r from-pink-100 to-teal-100 text-gray-800 px-4 py-2 rounded-full shadow-sm font-medium">
