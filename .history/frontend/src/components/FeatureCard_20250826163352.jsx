...
const FeatureCard = ({ icon, title, description, align }) => {
    return (
        <div className="text-center flex flex-col items-center">
            {/* Icon */}
            <div className="flex p-0 items-center justify-center mb-1">
                <div className="w-24 h-24 border-2 border-orange-500 rounded-full flex items-center justify-center mr-3">
                    {icon}
                </div>
            </div>
