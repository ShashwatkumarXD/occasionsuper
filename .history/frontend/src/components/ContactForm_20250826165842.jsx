    ...
    <section className="w-[95%]  mt-8 mx-auto p-2 relative overflow-hidden">
      ...
      <div className="m-[5px] relative z-10">
        ...
        <form className="space-y-6">
          ...
          <button
            type="submit"
            className="w-full bg-global-gradient text-white font-semibold p-4 rounded-lg flex items-center justify-center  transition-all duration-300 transform hover:scale-105 hover:cursor-pointer"
          >
