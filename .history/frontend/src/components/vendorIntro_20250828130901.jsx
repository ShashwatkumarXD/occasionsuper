    ...
    return (
        <div className="bg-[#f9fafb] min-h-screen p-4">
            ...
            <div className="mt-2 border-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                {/* New Leads */}
                <div className="bg-[#fff5f2] border-2 rounded-2xl p-2 h-3/4  shadow-sm flex flex-col items-center">
                ...
                {/* Upcoming Jobs */}
                <div className="bg-[#f0f6f8] rounded-2xl p-2 h-3/4 shadow-sm flex flex-col items-center">
                ...
                {/* Total Earnings */}
                <div className="bg-[#fff5f2] rounded-2xl p-2 h-3/4 shadow-sm flex flex-col items-center">
                ...
                {/* Completed */}
                <div className="bg-[#fff5f2] rounded-2xl p-2 h-5/6 shadow-sm flex flex-col items-center">
