...
const SearchBar = ({ onSearch }) => {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="flex items-center gap-2 bg-gradient-to-r from-pink-400 via-pink-500 to-pink-600 text-white px-5 py-2 rounded-xl hover:bg-pink-600 transition shadow-md w-full md:w-auto justify-center hover:cursor-pointer"
      >
        <Search size={18} />
        Search
      </button>
