    ...
    <section className="w-[95%]  mt-8 mx-auto p-2 relative overflow-hidden">
      ...
      <div className="m-[5px] relative z-10">
        ...
        <form className="space-y-6">
          ...
          <button
            type="submit"
            className=" group w-full bg-global-gradient text-white font-semibold p-4 rounded-xl flex items-center justify-center space-x-1 transition-all duration-300 hover:scale-3d hover:rounded-xl hover:bg-white hover:text-global-gradient hover:outline hover:outline-orange-600 transform hover:cursor-pointer"
          >
