...
function VendorIntro() {
    return (
        <div className="bg-[#f9fafb] min-h-screen p-4">
            ...
            {/* Stats Section */}
            <div className="mt-2 border-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-5">
                <div className="bg-[#fff5f2] rounded-2xl p-4 shadow-sm flex items-center">
                ...
                {/* Upcoming Jobs */}
                {/* <div className="bg-[#f0f6f8] rounded-2xl p-2 h-6/7 shadow-sm flex flex-col items-center">
                    <Calendar className="w-6 h-6 text-teal-500" />
                    <p className="text-gray-500 text-md">Upcoming Jobs</p>
                    <h2 className="text-2xl font-bold text-gray-800">0</h2>
                </div>

                <div className="bg-[#fff5f2] rounded-2xl p-2 h-6/7 shadow-sm flex flex-col items-center">
                ...
                <div className="bg-[#f0f6f8] rounded-2xl p-2 h-6/7 shadow-sm flex flex-col items-center">
                    ...
                    <p className="text-gray-500 text-md">Avg Rating</p>
                ...
                {/* Upcoming Jobs */}
                <div className="bg-[#f0f6f8] rounded-2xl p-4 shadow-sm flex items-center">
                    {/* Icon - 40% */}
                    <div className="flex justify-center basis-2/5">
