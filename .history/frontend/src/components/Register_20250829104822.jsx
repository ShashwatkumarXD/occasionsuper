...
import { FaUtensils, FaCamera, FaMusic, FaPalette, FaCalendarAlt, FaHotel } from "react-icons/fa";
...
export default function VendorForm() {
  ...
  return (
    <div className="max-w-3xl mx-auto bg-white shadow-md rounded-2xl p-8 mt-8">
      ...
      {step === 1 && (
        <div>
          <h3 className="text-xl font-semibold mb-4">Service Categories <span className="text-red-500">*</span></h3>
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <ServiceCard icon={<FaHotel />} title="Wedding Services" />
            <ServiceCard icon={<FaUtensils />} title="Catering" />
            <ServiceCard icon={<FaPalette />} title="Decoration" />
            <ServiceCard icon={<FaCamera />} title="Photography" />
            <ServiceCard icon={<FaMusic />} title="DJ/Music" />
            <ServiceCard icon={<FaCalendarAlt />} title="Event Planning" />
          </div>
        </div>
      )}
