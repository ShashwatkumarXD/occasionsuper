          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <input
                ...
                required
                className="w-full p-3 outline-1 outline-orange-500 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500 transition-all duration-300"
              />
            </div>
            <div>
              <input
