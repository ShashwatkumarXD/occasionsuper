    ...
    return (
        <div className="min-h-screen flex justify-center items-center">
            <form
                ...
                className="outline-1 mb-2 outline-[#E69B83] text-white p-4 rounded-xl shadow-md shadow-orange-500 w-full max-w-4xl"
            >
                ...
                <div className="flex items-center mt-4">
                    <input
                        ...
                        required
                    />
                    <Link to="" className="text-lg text-gray-500 hover:text-[#E69B83]">I agree to the Terms & Conditions</Link>
                </div>
