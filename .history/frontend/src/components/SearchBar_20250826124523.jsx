...
const SearchBar = ({ onSearch }) => {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="flex text-lg items-center gap-2 bg-global-gradient  text-white px-5 py-2 rounded-xl hover:text-orange-500 hover:!bg-white  transition shadow-md w-full md:w-auto justify-center hover:cursor-pointer"
      >
        <Search size={18}/>
        Search
      </button>
