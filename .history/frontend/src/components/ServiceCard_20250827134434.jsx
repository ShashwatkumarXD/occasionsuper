...
function ServiceCard({ image, title, subtitle, description }) {
  return (
    <div className="bg-white rounded-2xl outline-1 outline-[#E69B83] overflow-hidden hover:outline-2 hover:outline-[#E69B83] hover:shadow-lg hover:shadow-[#E69B83] transition-all duration-100 ease-linear">
      {/* Image Section */}
