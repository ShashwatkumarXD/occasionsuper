...
function Hero() {
  return (
    <div className="h-[90vh] w-full relative overflow-hidden">
      ...
      <section className="relative z-10  h-full w-full px-4 flex  md:flex-row items-center justify-end">
        {/* Left content - constrained to left half */}
        <div className="w-1/2 h-fit -translate-y-20 translate-x-20 border-2 items-center">
          <h1 className="text-4xl px-4 md:text-6xl font-extrabold text-gray-900 leading-snug">
