...
function Navbar() {
  return (
    <nav className="w-full text-xl flex items-center justify-between px-8 py-4 bg-white shadow-sm border-b border-gray-200">
      ...
      <Link
        to="/login"
        className="px-4 py-1 border border-[#E69B83] text-[#E69B83] rounded-lg hover:bg-[#E69B83] hover:text-white transition-all hover:shadow-md hover:shadow-[#E69B83] ease-linear"
      >
        Login
      </Link>
    </nav>
