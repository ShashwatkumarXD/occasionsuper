...
//             {/* Description */}
//             <p className={`text-gray-600 leading-relaxed max-w-xs mx-auto ${align === "left" ? "text-left" : "text-center"
//                 }`}>
//                 {description}
//             </p>
//         </div>
...
const FeatureCard = ({ icon, title, description, align }) => {
    return (
        <div className="text-center flex flex-col items-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-3 min-h-[3rem] flex items-center justify-center">
                {title}
            </h3>
