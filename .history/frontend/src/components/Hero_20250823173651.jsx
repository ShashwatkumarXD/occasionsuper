...
function Hero() {
  return (
    <section 
      className="h-2/3 w-full bg-blue-500 border-4 border-green-500 relative px-6 py-16 flex flex-col md:flex-row items-center bg-cover bg-center bg-no-repeat"
      style={{
