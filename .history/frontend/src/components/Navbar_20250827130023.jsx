  ...
  return (
    <nav className="w-full text-xl flex items-center justify-between px-8 py-4 bg-white shadow-sm border-b border-gray-200">
      ...
      <div className="flex gap-8 text-gray-700 font-medium">
        ...
        <Link to="/vendor-portal" className="hover-global hover:text-shadow hover:scale-110  transition-all ease-linear">
          Vendor Portal
        </Link>
      </div>
      ...
      <Link
        to="/login"
        className="px-4 py-1 border border-[#E69B83] text-[#E69B83] rounded-lg hover:bg-[#E69B83] hover:text-white transition-all hover:shadow-xl hover:shadow-[#E69B83] ease-linear"
      >
        Login
      </Link>
    </nav>
