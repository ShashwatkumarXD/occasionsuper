      ...
      <div className="w-screen mx-auto p-4 mt-8">
        <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-30 text-center md:text-left">
          ...
          <div className="max-w-xs">
            ...
            <div className="flex items-center rounded-xl outline-1 outline-gray-500 hover:outline-2 hover:outline-orange-500 active:outline-2 active:outline-orange-500 caret-orange-500">
              <input
              required
                type="email"
