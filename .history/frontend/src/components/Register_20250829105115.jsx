...
export default function VendorForm() {
  ...
  return (
    <div className="max-w-4xl mx-auto bg-gray-50 rounded-2xl p-8 mt-8 shadow-sm">
      {/* Progress Bar Header */}
      <div className="mb-8">
      ...
      {step === 1 && (
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            ...
            <ServiceCard icon={<CalendarDays size={32} />} title="Event Planning" />
          </div>
        </div>
      )}
...
function ServiceCard({ icon, title }) {
  return (
    <div className="border rounded-xl p-6 flex flex-col items-center hover:shadow-md cursor-pointer transition bg-white">
