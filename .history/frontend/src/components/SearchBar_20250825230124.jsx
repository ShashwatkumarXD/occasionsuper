  ...
  return (
    ...
    >
      ...
      <input
        ...
        className="w-full md:w-1/3 px-4 py-2 rounded-xl border border-gray-300 focus:ring-2 focus:ring-pink-400 focus:outline-none"
      />

      {/* Search Button */}
      <button
        type="submit"
        className="flex items-center gap-2 bg-pink-500 text-white px-5 py-2 rounded-xl hover:bg-pink-600 transition shadow-md w-full md:w-auto justify-center"
      >
        <Search size={18} />
        Search
      </button>
