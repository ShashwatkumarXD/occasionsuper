...
function ServiceCard({ image, title, subtitle, description }) {
  return (
    <div className="bg-white rounded-2xl overflow-hidden hover:outline-2 hover:outline-[#E69B83] hover:shadow-md hover:shadow-[#E69B83] transition-all duration-200 ease-linear">
      {/* Image Section */}
