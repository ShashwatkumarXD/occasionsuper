...
function Hero() {
  return (
    <div className="h-screen w-full bg-blue-500 border-4 border-green-500">
      <section 
        className="relative bg-gradient-to-r from-white to-gray-100 px-6 py-16 flex flex-col md:flex-row items-center bg-cover bg-center bg-no-repeat border-2 border-black"
        style={{
