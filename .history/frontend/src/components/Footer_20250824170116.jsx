...
const Footer = () => {
  return (
    <footer className="bg-white relative overflow-hidden">
      {/* Decorative pink petals */}
      <div className="absolute top-0 right-0 w-32 h-32 bg-pink-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></div>
      <div className="absolute bottom-0 right-0 w-24 h-24 bg-pink-200 rounded-full mix-blend-multiply filter blur-3xl opacity-30"></div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <div className="flex items-center border-b border-gray-300 pb-2">
              ...
              <PaperAirplaneIcon className="h-5 w-5 mt-0.5 text-black" />
              </button>
            </div>
          </div>
