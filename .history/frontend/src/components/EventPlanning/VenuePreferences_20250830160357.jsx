...
const VenuePreferences = ({ formData, setFormData }) => {
  ...
  return (
    <div className="bg-white rounded-2xl shadow-md p-4 mt-8 mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mt-8">
        {venues.map((venue) => (
          <div
            ...
            className={`cursor-pointer border rounded-xl p-4 transition hover:shadow-md ${
              formData.venuePreference === venue.title
                ? "border-[#E69B83] bg-orange-50"
