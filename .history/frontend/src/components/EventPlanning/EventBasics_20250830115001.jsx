      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-8    ">
        {eventTypes.map(({ name, icon: Icon }) => (
          <button
            ...
            className={`border rounded-xl py-4 flex flex-col items-center justify-center transition ${
              formData.eventType === name
                ? "border-2 border-[#E69B83] bg-orange-50 text-orange-500"
                : "border-gray-300 hover:border-2 hover:border-orange-300"
            }`}
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <input
            ...
            className="w-full border rounded-lg p-2 outline-none focus:ring-2 focus:ring-orange-400"
          />
        </div>
        <div>
