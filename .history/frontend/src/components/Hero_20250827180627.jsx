...
import { Sparkles, Brain, Target, Zap, Shield, Crown, Award, Search } from "lucide-react";

const Hero = () => {
  return (
    <section className="relative w-full bg-gradient-to-b from-white to-gray-50 py-16 px-8 lg:px-20">
      <div className="grid lg:grid-cols-2 gap-12 items-center">
        {/* Left Column */}
        <div className="space-y-8">
          {/* Badge */}
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-pink-100 to-teal-100 text-gray-800 px-4 py-2 rounded-full shadow-sm text-sm font-medium">
          ...
          <div className="flex gap-4">
            <button className="px-6 py-3 rounded-lg bg-gradient-to-r from-teal-500 to-[#E69B83] text-white font-medium shadow-md hover:scale-105 transition">
              Start AI Planning
            </button>
            <button className="px-6 py-3 rounded-lg border border-[#E69B83] text-[#E69B83] font-medium hover:bg-[#E69B83] hover:text-white transition">
              Explore Services
            </button>
          </div>
          ...
          <div className="bg-[#FFF5F2] border border-[#E69B83]/30 px-6 py-4 rounded-xl flex justify-between items-center max-w-lg">
            ...
            <button className="px-4 py-2 bg-[#E69B83] text-white rounded-lg hover:shadow-lg transition">
              Sign In
            </button>
          </div>
        </div>
