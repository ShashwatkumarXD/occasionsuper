        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              className="outline-1 hover:outline-2 hover:outline-[#E69B83] w-full rounded-lg"
            />
          </div>

          <div>
            <label className="block text-xl font-semibold mb-1">Account Number *</label>
            <input
              type="text"
              name="accountNumber"
              ...
              className="outline-1 hover:outline-2 hover:outline-[#E69B83] w-full rounded-lg p-3"
            />
          ...
          <div>
            <label className="block text-xl font-semibold mb-1">IFSC Code *</label>
            <input
              type="text"
              name="ifsc"
