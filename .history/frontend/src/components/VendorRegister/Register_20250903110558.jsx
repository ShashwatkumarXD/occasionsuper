...
//                         disabled={!isStepValid(step)}
//                         className="px-6 py-2 rounded-lg bg-green-600 hover:bg-green-700 text-white disabled:opacity-50 disabled:cursor-not-allowed"
//                     >
//                         Submit Application
//                     </button>
//                 )}
    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            const payload = {
                ...
                // Include Cloudinary URLs for files
