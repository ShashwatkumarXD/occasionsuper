...
const Step4VendorSignup = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-8 bg-gray-50 rounded-lg shadow-md">
      {/* Title */}
      <h2 className="text-3xl font-bold mb-6 text-center">Become a Vendor</h2>
      <div className="w-full h-1 bg-orange-300 mb-8"></div>
      ...
      <div className="flex justify-between">
        ...
        <button
          ...
          className="px-6 py-3 rounded-lg bg-orange-400 text-white hover:bg-orange-500"
        >
          Submit Application
        </button>
      </div>
...
export default Step4VendorSignup;
