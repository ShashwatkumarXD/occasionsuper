            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 ">
                ...
                <div className="flex flex-col">
                    ...
                    <Autocomplete
                        ...
                        //             ...params.InputProps,
                        //             className:
                        //                 "outline-1  rounded-xl px-3 py-2 focus:outline-2 focus:outline-red-500",
                        //         }}
                        //     />
                        // )}
                        ...
                        renderInput={(params) => (
                            <div ref={params.InputProps.ref}>
                                <input
                                    ...
                                    placeholder="Select your city"
                                    required
                                    className="w-full border border-gray-300 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-[#E69B83]"
                                />
                            </div>
                        )}
                    />
