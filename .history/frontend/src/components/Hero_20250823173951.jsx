...
function Hero() {
  return (
    <div className="h-[80vh] w-screen border-8 border-red-500 bg-yellow-400">
      <section 
        className="h-full w-full relative px-6 py-16 flex flex-col md:flex-row items-center bg-cover bg-center bg-no-repeat"
        style={{
