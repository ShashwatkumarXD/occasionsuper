                ...
                <div className="flex items-center h-16 justify-between px-8">
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <button
                            ...
                            className="bg-global-gradient text-white font-medium text-xl p-2 rounded-xl shadow-md outline outline-transparent hover:bg-white hover:text-global-gradient hover:outline-orange-600 transform hover:scale-105 transition-all duration-300 ease-in-out cursor-pointer"
                        >
                            Register as Vendor
                        </button>
                    </div>
