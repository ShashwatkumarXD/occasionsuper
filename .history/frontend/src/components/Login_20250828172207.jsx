  ...
  return (
    <div className="bg-white shadow-xl rounded-2xl p-8 md:p-12">
      ...
      <form className="space-y-5">
        ...
        <button
          type="submit"
          className="w-full text-2xl bg-[#E69B83] text-white font-semibold p-2 rounded-lg transition-all hover:shadow-md hover:[#E69B83] hover:bg-[#c16a4d] hover:cursor-pointer"
        >
          Login
        </button>
      </form>
