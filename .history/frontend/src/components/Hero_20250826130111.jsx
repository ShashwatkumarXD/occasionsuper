  ...
  return (
    <div className="h-[90vh] w-full relative overflow-hidden mt-16">
      ...
      <section className="relative z-10 h-full w-full flex md:flex-row items-center justify-end">
        {/* Left content */}
        <div className="w-[60%] h-fit -translate-y-20 translate-x-20 items-center">
          <h1 className="text-5xl px-1 font-extrabold text-global-gradient leading-snug">
            "Plan Your Dream Event
          </h1>
          <h1 className="text-5xl text-center px-1 font-extrabold text-global-gradient leading-snug">
            – Start Here"
          </h1>
        </div>
