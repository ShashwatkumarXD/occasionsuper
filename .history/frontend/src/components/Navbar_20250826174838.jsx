                ...
                <div className="flex items-center h-16 justify-between px-8">
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <button
                            ...
                            className="bg-global-gradient text-white font-medium text-xl p-2 rounded-xl hover:shadow-md hover:shadow-orange-500 outline outline-transparent hover:bg-white hover:text-global-gradient hover:outline-orange-600  hover:scale-105 transition-transform transition-colors duration-300 ease-linear cursor-pointer"
                        >
                            Register as Vendor
                        </button>
                    </div>
