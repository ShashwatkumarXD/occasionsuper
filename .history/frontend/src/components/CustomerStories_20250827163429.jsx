...
const reviews = [
  {
    ...
    name: "Priya Sharma",
    role: "Wedding Planning • OccasionSuper Customer",
  ...
  },
  {
    ...
    name: "Rahul Kapoor",
    role: "Corporate Event • OccasionSuper Customer",
  ...
  },
  {
    ...
    name: "Anjali Singh",
    role: "Birthday Party • OccasionSuper Customer",
  ...
  return (
    <section className="py-16 px-4 md:px-16 bg-white">
      <div className="text-center mb-12">
        <span className="inline-flex items-center gap-2 bg-[#dfdada] text-[#E69B83] px-4 py-2 rounded-full text-lg font-medium">
          ❤️ Customer Stories
        </span>
