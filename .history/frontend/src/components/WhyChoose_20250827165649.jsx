...
import { CheckCircle, Star, Calendar, Users, CheckCircle } from "lucide-react";
  ...
  return (
    <div className="bg-gray-50 py-16 px-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
        <div>
          <div className="flex justify-center items-center w-16 h-16 mx-auto mb-4 bg-white rounded-2xl shadow">
      ...
      <div className="grid md:grid-cols-2 gap-8 mt-20">
        ...
        <div className="bg-white rounded-2xl shadow p-8">
          <h3 className="flex items-center text-2xl font-bold mb-4 text-gray-800">
            <span className="text-orange-400 mr-2">🛡️</span> Quality Guarantee
          </h3>
        ...
        <div className="bg-white rounded-2xl shadow p-8">
          <h3 className="flex items-center text-2xl font-bold mb-4 text-gray-800">
            <span className="text-teal-600 mr-2">🏅</span> Premium Support
          </h3>
          <p className="text-gray-600 mb-4">
