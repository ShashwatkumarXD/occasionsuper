...
function Hero() {
  return (
    <div className="h-[90vh] w-full relative overflow-hidden">
      ...
      {/* Content section */}
      <section className="relative z-10 h-full w-full px-8 md:px-16 flex flex-col md:flex-row items-center">
        ...
        <div className="md:w-1/2 relative flex justify-end">
          <img
            src={Image}
            alt="Bride"
            className="h-[120%] object-cover relative -translate-y-8 drop-shadow-2xl"
          />
        </div>
      </section>
    </div>
