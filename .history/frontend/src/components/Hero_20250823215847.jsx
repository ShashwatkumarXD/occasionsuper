...
function Hero() {
  return (
    <div className="h-[90vh] w-full relative overflow-hidden">
      ...
      <section className="relative z-10 border-10 h-full w-full px-8 md:px-16 flex  md:flex-row items-start justify-end mt-10 pt-16">
        ...
        <div className="w-1/2 mt-10 border-2 h-[80%] flex items-end justify-end relative">
          <img
            src={Image}
            alt="Bride"
            className="h-[140%] object-cover absolute bottom-0 right-0 -translate-y-16 drop-shadow-2xl"
