...
const SearchBar = ({ onSearch }) => {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="flex items-center gap-2 bg-global-gradient  text-white px-5 py-2 rounded-xl hover:text-global-gradient hover:bg-white transition shadow-md w-full md:w-auto justify-center hover:cursor-pointer"
      >
        <Search size={18}/>
        Search
      </button>
