          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <input
                ...
                className="w-full px-6 py-4 bg-gray-400 border border-gray-700 rounded-lg text-black placeholder-gray-400 focus:outline-none focus:border-purple-500 focus:ring-2 focus:ring-purple-500 transition-all duration-300"
              />
            </div>
            <div>
              <input
