...
function ServiceCard({ image, title, subtitle, description }) {
  return (
    <div className="bg-white rounded-2xl border-none overflow-hidden hover:outline-2 hover:outline-[#E69B83] hover:shadow-md hover:shadow-[#E69B83] transition-all duration-300 ease-linear">
      {/* Image Section */}
