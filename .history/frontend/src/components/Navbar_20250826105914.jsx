            ...
            <div className="max-w-7xl mx-auto px-6">
                <div className="flex items-center h-16 justify-between px-8">
                    ...
                    <div className="flex items-center gap-8">
                        ...
                        <button
                            onClick={() => navigate("/vendorReg")}
                            className="bg-orange-600 text-white font-medium text-xl p-2 rounded-xl shadow-md hover:bg-purple-600 active:bg-purple-700 transition hover:cursor-pointer"
                        >
                            Register as Vendor
                        </button>
                    </div>
