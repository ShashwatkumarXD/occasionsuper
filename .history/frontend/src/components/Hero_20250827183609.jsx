        ...
        <section className="relative w-full bg-white p-8">
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="space-y-8">
                    {/* Badge */}
                    <div className="border-2 text-lg inline-flex items-center gap-1 bg-gradient-to-r from-pink-100 to-teal-100 text-gray-800 px-4 py-2 rounded-full shadow-sm font-medium">
                        <Sparkles className="w-4 h-4 text-[#E69B83]" />
                        AI-Powered Event Management
                    </div>

                    {/* Heading */}
                    <h1 className="text-5xl font-extrabold leading-tight text-gray-900 border-2">
