  ...
  return (
    <div className="h-[90vh] w-full relative overflow-hidden">
      ...
      <section className="relative z-10 h-full w-full px-8 md:px-16 flex flex-col md:flex-row items-center justify-between">
        ...
        {/* Right image */}
        <div className="w-screen ranslate-x-100 translate-y-5 border-2 h-full flex items-end justify-end relative">
          <img
            src={Image}
            alt="Bride"
            className="h-[120%] p-0 object-cover border-20 absolute bottom-0 right-0 -translate-y-8 drop-shadow-2xl"
          />
        </div>
      </section>
    </div>
