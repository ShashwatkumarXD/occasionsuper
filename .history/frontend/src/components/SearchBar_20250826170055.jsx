...
const SearchBar = ({ onSearch }) => {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="group flex items-center gap-2 bg-global-gradient text-white font-medium text-xl p-2 rounded-xl outline outline-transparent hover:bg-white hover:text-global-gradient hover:outline-orange-600 transform hover:scale-105 transition-all duration-500 ease-in-out cursor-pointer"
      >
