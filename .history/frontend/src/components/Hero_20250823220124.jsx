...
//         {/* Right image */}
//         <div className="md:w-1/2 w-screen h-2/3 flex items-end justify-end relative">
//           <img
//             src={Image}
//             alt="Bride"
...
function Hero() {
  return (
    <div className="h-[90vh] w-full relative overflow-hidden">
      ...
      <section className="relative z-10 border-10 h-full w-full px-8 md:px-16 flex  md:flex-row items-center justify-end  pt-16">
        {/* Left content - constrained to left half */}
        <div className="w-1/2 space-y-8 items-center">
          <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 leading-snug">
            "Plan Your Dream Event – Start Here"
          </h1>

          {/* Search bar - positioned above image area */}
          <div className="flex bg-black text-white px-6 py-4 rounded-lg w-full items-center shadow-lg">
            <span className="font-semibold text-sm whitespace-nowrap mr-4">
              FIND <span className="text-purple-500">OCCASION SUPER</span> IN YOUR CITY
            </span>
            <div className="flex flex-1 items-center gap-3">
        ...
        <div className="w-fit-content border-2 h-[70%] flex items-end justify-end relative">
          <img
            src={Image}
            alt="Bride"
            className="h-[140%] border-5 object-cover absolute bottom-0 right-0 -translate-y-16 drop-shadow-2xl"
          />
        </div>
      </section>
    </div>
