...
const SearchBar = ({ onSearch }) => {
  ...
  return (
    ...
    >
      ...
      <button
        type="submit"
        className="group flex items-center gap-2 bg-global-gradient text-white font-medium text-xl p-2 rounded-xl outline outline-transparent hover:bg-white hover:text-global-gradient hover:outline-orange-600 hover:scale-105 group-hover:shadow group-hover:shadow-orange-500 transition-transform duration-300 ease-linear cursor-pointer"
      >
        <Search size={18} className="text-white group-hover:text-orange-500 transition-colors duration-300 ease-in-out" />
        Search
      </button>
