...
function ServiceCard({ image, title, subtitle, description }) {
  return (
    <div className="bg-white rounded-2xl outline-none overflow-hidden hover:outline-8 hover:outline-[#E69B83] hover:shadow-md hover:shadow-[#E69B83] transition-all duration-300 ease-linear">
      {/* Image Section */}
