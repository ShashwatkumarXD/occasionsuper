...
const Footer = () => {
  return (
    ...
    //     <div className="grid border-8 grid-cols-1 md:grid-cols-3 gap-12">
    ...
    <div className="w-screen mx-auto px-4 py-16">
      <div className="flex flex-col md:flex-row justify-center items-center md:items-start gap-20 text-center md:text-left">
